...
const Navbar = () => {
  ...
  return (
    <nav className={isAuthorized ? "navbarShow" : "navbarHide"}>
      <div className="container">
        <div className="logo">
          <img src="/blackwhite.png" alt="logo" />
        </div>
  ...
  {user && user.role === "Job Seeker" ? (
    <>
      <li>
    <Link to={"/improve-with-ai"} onClick={() => setShow(false)}>IMPROVE WITH AI</Link>
  ...
  <button onClick={() => window.open("https://vickybytes.com/", "_blank")}>
  SHOWCASE YOUR PROJECT ON Vicky Bytes.
</button>
